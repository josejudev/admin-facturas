    ...
    <div >
      <div className="container flex flex-wrap items-center gap-4 mx-auto">
        ...
        <button
          onClick={() => setModal(true)}
          type="button"
          className="text-white bg-indigo-300 hover:bg-sky-500 border  focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 "
        >
          Abrir modal
        </button>
